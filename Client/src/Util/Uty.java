...
//    }
    ...
    public static void WriteMapToFile(HashMap<String, Object> hmap, String outputFile) {
        File fileOne = new File(outputFile);
...
//        return baos.toByteArray();
    ...
    public static void writeImgToFile(BufferedImage image, File outputFile) {
//        File fileOne = new File(outputFile);
        FileOutputStream fos = null;
        try {
